...
public final class FakebookOracleMain {
    // Member Variables
    private static String username = "lernerbe"; // replace with your uniqname
    private static String password = "blerner"; // replace with your Oracle password (default: eecsclass)
